...
//    @PartMap() Map<String, RequestBody> partMap
    ...
    private void groupListCallHttp(){
        ...
        final Call<ArrayList<GroupListResults>> response = ListRestAdapter.getInstance().getGroupListData(authorization);
        response.enqueue(new Callback<ArrayList<GroupListResults>>() {
            @Override
            ...
            @Override
            public void onFailure(Call<ArrayList<GroupListResults>> call, Throwable t) {
